...
def _segm_resnet(name, backbone_name, num_classes, output_stride, pretrained_backbone):
    ...
    backbone = resnet.__dict__[backbone_name](
        ...
        replace_stride_with_dilation=replace_stride_with_dilation)   #如果backbone_name为“resnet50”，则返回resnet50函数的执行结果
    ...
    backbone2 = IntermediateLayerGetter(backbone, return_layers=return_layers)

    model = DeepLabV3(backbone1,backbone2, classifier)
    return model
