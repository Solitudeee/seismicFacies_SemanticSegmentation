...
class YQYvocDataSet_Feature_xline():
    def __init__(self, data_path,name_path,seed=None):
        self.data_path = data_path
        self.name_path = name_path
        self.w = 782
